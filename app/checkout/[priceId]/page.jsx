                                    ...
                                    <div className="col-12 mt-3">
                                        {loading ? (
                                            ...
                                            <div className="col-12 mt-3 ms-1">
                                                    <Button className='text-white rounded-pill' variant="primary" size="sm" disabled={!fields.terms} onClick={() => handleSubmit()}>
                                                    {`Pay Now ${pricing?.currency}${pricing?.raw_price}`}
                                                </Button>
                                                    <Button variant="secondary" size="sm" className="ms-2 text-white rounded-pill" onClick={() => handleClose()}>
                                                    Close
                                                </Button>
                                            </div>
                                        )}
